              ...
              <td><p>
				...
				if ($num_rows != 0) {
					while($row = mysql_fetch_assoc($result)) {
						$checked="";
						$limitedSubject=split(",",$myRs['LimitedSubjects']);
