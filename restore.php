...
$sql="INSERT INTO `Preferences` VALUES (1, '<p><span style=\"font-size: 14pt; font-family: arial;\">Vítame Vás. Vyberte si test a mozete zacat.</span></p>\r\n', '/mimetex.cgi', 'Poznamka');";

$result=mysql_query($sql)
	or die(mysql_error());

$sql="INSERT INTO `ReportTemplates` VALUES (1, '[Default]', 'Default Template', '<span style=\"font-family: arial;\">Hodnotenie pre %FIRST_NAME% %LAST_NAME%</span><br style=\"font-family: arial;\">\r\n<br style=\"font-family: arial;\"><span style=\"font-family: arial;\">\r\nTest: %TEST_NAME%</span><br style=\"font-family: arial;\"><span style=\"font-family: arial;\">\r\nDatum: %TEST_DATE%</span><br style=\"font-family: arial;\">\r\n<br style=\"font-family: arial;\"><span style=\"font-family: arial;\">\r\nSpravne celkom: %NUMBER_CORRECT%</span><br style=\"font-family: arial;\"><span style=\"font-family: arial;\">\r\nMax.bodov: %NUMBER_POSSIBLE%</span><br style=\"font-family: arial;\"><span style=\"font-family: arial;\">\r\nSkore:  %PERCENTAGE%</span><br style=\"font-family: arial;\">\r\n<br style=\"font-family: arial;\"><span style=\"font-family: arial;\">\r\nVysledne hodnotenie je %PASSFAIL% .</span><br>\r\n');";

$result=mysql_query($sql)
	or die(mysql_error());

$sql="INSERT INTO `EmailTemplates` VALUES (1, '[Default]', 'Default Template', 'results@webtester.us', '%TEST_NAME% Hodnotenie pre %FIRST_NAME% %LAST_NAME%', 'Vysledok pre %FIRST_NAME% %LAST_NAME%\r\n\r\nTest: %TEST_NAME%\r\nDatum: %TEST_DATE%\r\nSpravne celkom: %NUMBER_CORRECT%\r\nMax.bodov: %NUMBER_POSSIBLE%\r\nSkore:  %PERCENTAGE%\r\n\r\nVysledné hodnotenie je %PASSFAIL% .\r\n\r\n');";
